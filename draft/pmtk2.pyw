...
#######################################################
prg_tittle = ''' Password Manager 2-tkinter- v. 2.2''' 
#######################################################
# author: Jorge Monti
...
# class ShowDF(tk.Frame):
#     ''' Basic DF display in a table using pandastable library'''
#     def __init__(self, df, parent=None):
#         self.parent = parent
#         tk.Frame.__init__(self)
#         self.main = self.master
#         self.main.geometry('1050x750+100+50')
#         self.main.title(f'{prg_tittle} plus Table')
#         f = tk.Frame(self.main)
#         f.grid(row=6, column=1, padx=10, pady=10)
